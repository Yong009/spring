	...
	$(document).ready(function (){
		...
		$('button').on('click',function(e){
			...
			if(operation == 'remove'){
				...
				//return;
				//pageNum, amount = > clone() -> empty() -> append(clone)
				var pageNumTage = formObj.find('input[name="pageNum"]').clone();
				var amountTag = formObj.find('input[name="amount"]').clone();
				var Type = formObj.find('input[name="type"]').clone();
				var keyword = formObj.find('input[name="keyword"]').clone();
